...
public class Scanner {
	...
	static {
		...
		literals.put("passo", new Integer(22));
		literals.put("faca", new Integer(23));
		literals.put("fimpara", new Integer(24));
		literals.put("enquanto", new Integer(25));
		literals.put("fimenquanto", new Integer(26));
		literals.put("repita", new Integer(33));
		literals.put("se", new Integer(34));
		literals.put("entao", new Integer(35));
		literals.put("senao", new Integer(36));
		literals.put("fimse", new Integer(37));
		literals.put("caso", new Integer(38));
		literals.put("outrocaso", new Integer(39));
		literals.put("fimcaso", new Integer(40));
		literals.put("seja", new Integer(41));
		literals.put("leia", new Integer(42));
		literals.put("escreva", new Integer(43));
		literals.put("novo", new Integer(49));
